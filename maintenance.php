...
<div class="main ds-flex ds-bg-dark ds-pad-3 ds-mar-t-3" >
  <div class="ds-flex ds-flex-justify-center ds-flex-col">
    <h2 class="ds-heading-1 ds-mar-b-3 ds-slide-up ds-animation-delay-2">Oops!</h2>
    <h4 class="ds-heading-3 ds-mar-b-3 ds-slide-up ds-animation-delay-4">We will be back soon. PASIR is currently down for maintanance.</h4>
...
<!-- Theme Switcher -->
<div class="ds-bg-dark ds-bg-blue-8 ds-shadow-floating theme-switcher">
  <div class="active-highlight"></div>
  <div class="theme theme-default active-theme">
    <p class="ds-label ds-mar-b-0">Default</p>
  </div>
  <div class="theme theme-compact">
    <p class="ds-label ds-mar-b-0">Compact</p>
  </div>
</div>
...
<script>
  var themes = {
    ...
    {
      el: document.querySelector('.theme-compact'),
      href: './lib/w3ds/w3ds-compact.css',
      status: true,
      translation: '100',
    },
    ],
  ...
  themes.opts.forEach(function(opt) {
